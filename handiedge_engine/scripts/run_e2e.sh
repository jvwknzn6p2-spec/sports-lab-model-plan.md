...
echo "== 3. predict (incl. calibration + AI multi-agent review) =="
...
echo "== 4. AI multi-agent review (Step 9) =="
python -m app.cli.main ai-review "$PREDICTION_ID"
